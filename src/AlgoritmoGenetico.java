...
public class AlgoritmoGenetico {
	...
	public void ejecutarAlgoritmoGenetico() {
		...
		System.out.println("Population Size = " + this.numeroPoblacion);
		System.out.println("Number of generations = "
				+ this.numeroGeneraciones);

		System.out.println("Crossover value = " + this.cruce);
		System.out.println("Mutation value = " + this.mutacion);
		System.out.println("----------------------------");
	...
	public static int numeroPoblacion = 1;
